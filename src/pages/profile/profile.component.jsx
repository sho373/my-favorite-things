...
const Profile = () => {
  ...
  const updateDisplay = async (event) => {
    if (displayName !== currentUser.displayName && displayName) {
      ...
      try {
        ...
        setOpen({ isError: true, errorMes: { displayname: error.message } });
      }
    }
  };
        ...
        editUser
          ...
          .then(function () {
            editUser
              ...
              .catch(function (error) {
                // An error happened.
                setOpen({ isError: true, errorMes: { email: error.message } });
              });
          })
          .catch(function (error) {
            setOpen({ isError: true, errorMes: { email: error.message } });
      ...
      editUser
        ...
        .then(function () {
          editUser
            ...
            .catch(function (error) {
              setOpen({ isError: true, errorMes: { password: error.message } });
              return;
            });
        })
        .catch(function (error) {
  ...
  const deleteAcocunt = async (event) => {
    try {
      ...
      editUser
        ...
        .catch(function (error) {
          setOpen({ isError: true, errorMes: { delete: error.message } });
        });
    } catch (error) {
      setOpen({ isError: true, errorMes: { delete: error.message } });
    }
  ...
  return (
    <div data-testid="profile" className="profile">
      ...
      {currentUser ? (
        <>
          <span className="edit-display-name">
            Display name:{' '}
            <span className="dis-char">{currentUser.displayName}</span>
            <Tooltip title="Edit">
              <EditIcon
