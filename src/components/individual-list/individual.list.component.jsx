    ...
    <div>
      <Link to="/">
        <ListItem
          ...
          onDoubleClick={() => setOpen({ isEditing: !isEditing })}
          key={list.docId}
        >
          <ListItemIcon>
            {list.genreName === 'book' ? (
          ...
          <ListItemSecondaryAction key={list.docId}>
            <Tooltip title="Delete">
              <IconButton
                ...
                onClick={() => setOpen({ showConfirm: !showConfirm })}
                style={{ color: '#dcdcdc' }}
                edge="end"
                aria-label="delete"
              >
            ...
            {showConfirm && (
              ...
              >
                <DialogTitle>
                  Are you sure you want delete &ldquo;{list.name}&rdquo; ?
                </DialogTitle>
                <DialogActions>
                  <Button
                    variant="outlined"
      ...
      {isEditing && (
        ...
        >
          ...
          <DialogActions>
            <Button
              variant="outlined"
              onClick={() => setOpen({ isEditing: !isEditing })}
              color="default"
            >
              Cancel
            </Button>
